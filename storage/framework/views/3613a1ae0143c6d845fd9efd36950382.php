            ...
            <form action="<?php echo e(route('verifikasi.tolak', $laporan->id)); ?>"
                ...
                <div class="w-full sm:flex-1">
                    <input
                        ...
                        class="w-full rounded-lg border border-gray-300 py-3 px-4">
                </div>

                <button
                    class="rounded-lg border border-red-500 py-3 px-8 text-red-500 hover:bg-red-500 hover:text-white">
                    Tolak Laporan
                </button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\akuna\OneDrive\Dokumen\ARIYA MILAARA\pkn\Bot-Monitoring-Pekerjaan\Bot-Monitoring-Pekerjaan\resources\views/verifikasi/show.blade.php ENDPATH**/ ?>