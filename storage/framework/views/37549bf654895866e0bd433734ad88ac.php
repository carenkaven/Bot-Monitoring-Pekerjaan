...
<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900 shadow-md">
    ...
    <div class="p-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start w-full">
            <form action="<?php echo e(route('verifikasi.tolak', $laporan->id)); ?>" method="POST" class="flex flex-col sm:flex-row gap-3 w-full">
                <?php echo csrf_field(); ?>
            ...
            <form action="<?php echo e(route('verifikasi.setujui', $laporan->id)); ?>" method="POST" class="w-full sm:w-auto">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\akuna\OneDrive\Dokumen\KULIAH ITN MALANG\SEMESTER 7\PKN 2318105\Bot-Monitoring-Pekerjaan\resources\views/verifikasi/show.blade.php ENDPATH**/ ?>