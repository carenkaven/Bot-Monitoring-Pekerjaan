<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-slate-100 transition-colors duration-300">
            <?php echo e(__('Profile Information')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600 dark:text-slate-300 transition-colors duration-300">
...
<?php endif; ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800 dark:text-slate-200 transition-colors duration-300">
                        <?php echo e(__('Your email address is unverified.')); ?>


                        <button form="send-verification" class="underline text-sm text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-slate-900 focus:ring-indigo-500 transition-colors duration-300">
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                <p
                    ...
                    class="text-sm text-gray-600 dark:text-slate-300 transition-colors duration-300"
                ><?php echo e(__('Saved.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH C:\Users\akuna\OneDrive\Dokumen\KULIAH ITN MALANG\SEMESTER 7\PKN 2318105\Bot-Monitoring-Pekerjaan\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>