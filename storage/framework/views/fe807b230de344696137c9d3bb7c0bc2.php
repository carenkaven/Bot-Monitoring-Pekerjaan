    ...
    <div class="relative z-10 block w-full lg:w-1/2 h-screen overflow-y-auto custom-scrollbar">
        <div class="flex flex-col items-center justify-center min-h-full p-6 lg:p-12">
            ...
            <div
                ...
                <?php if(session('success')): ?>
                    <div class="mb-6 rounded-xl border border-green-500/20 bg-green-500/10 p-4">
                        <p class="text-sm font-medium text-green-600 dark:text-green-400"><?php echo e(session('success')); ?></p>
                    </div>
                <?php endif; ?>

                <form action="<?php echo e(route('register.karyawan.store')); ?>" method="POST" class="space-y-5 text-left">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="jabatan" required
                            ...
                            <option value="Supervisor" <?php echo e(old('jabatan') == 'Supervisor' ? 'selected' : ''); ?>>Supervisor
                            </option>
                            <option value="Site Engineer" <?php echo e(old('jabatan') == 'Site Engineer' ? 'selected' : ''); ?>>Site
                                Engineer</option>
                            <option value="Quality Control" <?php echo e(old('jabatan') == 'Quality Control' ? 'selected' : ''); ?>>
                                Quality Control</option>
                            <option value="Safety Officer" <?php echo e(old('jabatan') == 'Safety Officer' ? 'selected' : ''); ?>>
                    ...
                    <div class="flex flex-col sm:flex-row gap-5">
                        <div class="w-full sm:w-1/2">
                            <label class="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-200">No
                                WhatsApp</label>
                            <input type="text" name="no_hp" value="<?php echo e(old('no_hp')); ?>" placeholder="08xxxxxxxx" required
                                class="w-full rounded-xl border border-slate-200 bg-white/50 backdrop-blur-sm py-3 px-5 text-sm outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 dark:border-slate-700 dark:bg-slate-800/50 dark:text-white dark:focus:border-blue-400 transition-all" />
                        </div>
            ...
            <div class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
                <p>Sudah mempunyai akun? <a href="<?php echo e(route('login')); ?>"
...
</html><?php /**PATH C:\Users\akuna\OneDrive\Dokumen\ARIYA MILAARA\pkn\Bot-Monitoring-Pekerjaan\Bot-Monitoring-Pekerjaan\resources\views/auth/register-karyawan.blade.php ENDPATH**/ ?>