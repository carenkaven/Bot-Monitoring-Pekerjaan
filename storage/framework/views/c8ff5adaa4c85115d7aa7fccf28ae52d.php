...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'block h-9 w-auto fill-current text-gray-800 dark:text-slate-100']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block h-9 w-auto fill-current text-gray-800 dark:text-slate-100']); ?>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-slate-800">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-slate-100"><?php echo e(Auth::user()->name); ?></div>
                <div class="font-medium text-sm text-gray-500 dark:text-slate-300"><?php echo e(Auth::user()->email); ?></div>
            </div>
...
<?php /**PATH C:\PROJECT FANY\Bot-Monitoring-Pekerjaan\resources\views\layouts\navigation.blade.php ENDPATH**/ ?>