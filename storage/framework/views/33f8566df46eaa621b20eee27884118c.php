...
<td class="no-border"><?php echo e(strtoupper($laporan->pekerjaan)); ?></td>
</tr>

<tr>
<td class="no-border bold">Lokasi</td>
<td class="no-border">:</td>
<td class="no-border"><?php echo e(strtoupper($laporan->lokasi)); ?></td>
</tr>

<tr>
<td class="no-border bold">Tahun Anggaran</td>
<td class="no-border">:</td>
<td class="no-border"><?php echo e(date('Y',strtotime($laporan->tanggal))); ?></td>
</tr>

<tr>
<td class="no-border bold">Minggu Ke</td>
<td class="no-border">:</td>
<td class="no-border"><?php echo e($summary['minggu_ke']); ?></td>
</tr>
...
<td class="no-border">:</td>
<td class="no-border">
<?php echo e(\Carbon\Carbon::parse($summary['tanggal_mulai'])->format('d F Y')); ?>

s/d
<?php echo e(\Carbon\Carbon::parse($summary['tanggal_selesai'])->format('d F Y')); ?>
...
<td class="no-border">:</td>
<td class="no-border"><?php echo e($laporan->tanggal->translatedFormat('d F Y')); ?></td>
</tr>
...
<?php for($i=0;$i<11;$i++): ?>
<tr>
<td class="center h20"><?php echo e($i+1); ?></td>
<td class="h20"><?php echo e($pekerjaan[$i]->nama_pekerjaan ?? ''); ?></td>
</tr>
<?php endfor; ?>
...
<tr>
<td class="center h20"><?php echo e($i+1); ?></td>
<td><?php echo e($materials[$i]->nama_material ?? ''); ?></td>
<td class="center">
<?php if(isset($materials[$i])): ?>
<?php echo e(rtrim(rtrim(number_format($materials[$i]->volume,2,'.',''),'0'),'.')); ?>

<?php endif; ?>
</td>
<td class="center"><?php echo e($materials[$i]->satuan ?? ''); ?></td>
<td class="center">
<?php if(($materials[$i]->status ?? '')=='Diterima'): ?>
✔
<?php endif; ?>
</td>
<td class="center">
<?php if(($materials[$i]->status ?? '')=='Ditolak'): ?>
✖
<?php endif; ?>
</td>
<td><?php echo e($materials[$i]->keterangan ?? ''); ?></td>
</tr>
<?php endfor; ?>
...
<td>Pekerja</td>
<td class="center"><?php echo e($totalPekerja); ?></td>
<td class="center italic">org</td>
<td class="center">1</td>
<td><?php echo e($alat[0]->nama_alat ?? ''); ?></td>
<td class="center"><?php echo e($alat[0]->jumlah ?? ''); ?></td>
<td class="center"><?php echo e($alat[0]->satuan ?? ''); ?></td>
<td><?php echo e($alat[0]->keterangan ?? ''); ?></td>
</tr>

<tr>
<td class="center">2</td>
<td>Tukang</td>
<td class="center"><?php echo e($totalTukang); ?></td>
<td class="center italic">org</td>
<td class="center">2</td>
<td><?php echo e($alat[1]->nama_alat ?? ''); ?></td>
<td class="center"><?php echo e($alat[1]->jumlah ?? ''); ?></td>
<td class="center"><?php echo e($alat[1]->satuan ?? ''); ?></td>
<td><?php echo e($alat[1]->keterangan ?? ''); ?></td>
</tr>

<tr>
<td class="center">3</td>
<td>Mandor</td>
<td class="center"><?php echo e($totalMandor); ?></td>
<td class="center italic">org</td>
<td class="center">3</td>
<td><?php echo e($alat[2]->nama_alat ?? ''); ?></td>
<td class="center"><?php echo e($alat[2]->jumlah ?? ''); ?></td>
<td class="center"><?php echo e($alat[2]->satuan ?? ''); ?></td>
<td><?php echo e($alat[2]->keterangan ?? ''); ?></td>
</tr>

<tr>
<td class="center">4</td>
<td>Pelaksana Lapangan</td>
<td class="center"><?php echo e($totalPelaksana); ?></td>
<td class="center italic">org</td>
<td class="center">4</td>
<td><?php echo e($alat[3]->nama_alat ?? ''); ?></td>
<td class="center"><?php echo e($alat[3]->jumlah ?? ''); ?></td>
<td class="center"><?php echo e($alat[3]->satuan ?? ''); ?></td>
<td><?php echo e($alat[3]->keterangan ?? ''); ?></td>
</tr>
...
<td><?php echo e($alat[$i]->nama_alat ?? ''); ?></td>
<td class="center"><?php echo e($alat[$i]->jumlah ?? ''); ?></td>
<td class="center"><?php echo e($alat[$i]->satuan ?? ''); ?></td>
<td><?php echo e($alat[$i]->keterangan ?? ''); ?></td>
</tr>
<?php endfor; ?>
...
<td class="center h20"><?php echo e($jamMulai); ?> - <?php echo e($jamSelesai); ?></td>

<td class="h20 <?php echo e($classKerja); ?>"></td>

<td class="h20"></td>

<td class="h20 <?php echo e($classCuaca); ?>"></td>
...
<?php echo e($laporan->lokasi_ttd ?? 'Malang'); ?>, <?php echo e($laporan->tanggal->translatedFormat('d F Y')); ?>
...
<tr>
<td class="no-border center bold"><?php echo e($laporan->nama_konsultan ?? ''); ?></td>
<td class="no-border"></td>
<td class="no-border center bold"><?php echo e($laporan->nama_kontraktor ?? ''); ?></td>
</tr>
...
<tr>
<td class="no-border center bold" style="text-decoration:underline;"><?php echo e($laporan->nama_inspector ?? ''); ?></td>
<td class="no-border"></td>
<td class="no-border center bold" style="text-decoration:underline;"><?php echo e($laporan->nama_pelaksana ?? ''); ?></td>
</tr>
...
<?php /**PATH C:\Users\akuna\OneDrive\Dokumen\ARIYA MILAARA\pkn\Bot-Monitoring-Pekerjaan\Bot-Monitoring-Pekerjaan\resources\views/pdf/daily-weekly.blade.php ENDPATH**/ ?>