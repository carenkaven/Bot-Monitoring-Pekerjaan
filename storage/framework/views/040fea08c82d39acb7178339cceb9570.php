                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-meta-4/50 transition">
                            ...
                            <td class="py-4 px-2">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <button type="button"
                                        onclick="pilihFormatLaporan('Laporan Mingguan Lama', '<?php echo e(route('pdf.weekly', ['minggu' => $row['minggu_ke'], 'proyek' => $row['nama_proyek']])); ?>', '<?php echo e(route('excel.weekly', ['minggu' => $row['minggu_ke'], 'proyek' => $row['nama_proyek']])); ?>')"
                                    ...
                                    <button type="button"
                                        onclick="pilihFormatLaporan('Laporan Mingguan Baru', '<?php echo e(route('pdf.weekly.physical', ['minggu' => $row['minggu_ke'], 'proyek' => $row['nama_proyek']])); ?>', '<?php echo e(route('excel.weekly.physical', ['minggu' => $row['minggu_ke'], 'proyek' => $row['nama_proyek']])); ?>')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\akuna\OneDrive\Dokumen\PKN 2026\Bot-Monitoring-Pekerjaan\resources\views/weekly/index.blade.php ENDPATH**/ ?>