...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('laporan-saya.index')); ?>" class="bg-slate-200 hover:bg-slate-300 text-slate-700 px-5 py-2.5 rounded-xl">Kembali</a>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6">
                ...
                <p class="text-sm"><span class="text-slate-500">Diverifikasi oleh:</span> <b><?php echo e($laporan->verifikasi->user->name ?? '-'); ?></b></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\akuna\OneDrive\Dokumen\ARIYA MILAARA\pkn\Bot-Monitoring-Pekerjaan\Bot-Monitoring-Pekerjaan\resources\views/karyawan/laporan/show.blade.php ENDPATH**/ ?>