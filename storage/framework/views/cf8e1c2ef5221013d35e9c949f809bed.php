...
>
    ...
    <body class="font-sans text-gray-900 dark:text-slate-100 antialiased bg-gray-100 dark:bg-slate-900 transition-colors duration-300">
...
<?php endif; ?>
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-slate-800 shadow-md overflow-hidden sm:rounded-lg transition-colors duration-300">
                <?php echo e($slot); ?>
...
<?php /**PATH C:\PROJECT FANY\Bot-Monitoring-Pekerjaan\resources\views\layouts\guest.blade.php ENDPATH**/ ?>