...
<div class="page">
<div class="center">
<?php if(file_exists(public_path('images/logo-kabupaten.png'))): ?>
<img src="<?php echo e(public_path('images/logo-kabupaten.png')); ?>" class="logo">
<?php endif; ?>
...
<div><?php echo e($summary['nomor_spk'] ?? '-'); ?></div>
<div><?php echo e($summary['tanggal_spk'] ?? \Carbon\Carbon::parse($summary['tanggal_mulai'])->format('d-m-Y')); ?></div>

<div class="title" style="margin-top:40px">LAPORAN MINGGUAN</div>
<div class="subtitle">MINGGU KE <?php echo e($summary['minggu_ke']); ?></div>
...
<div class="value"><?php echo e(strtoupper($summary['kegiatan'])); ?></div>

<div class="label">SUB KEGIATAN</div>
<div class="value"><?php echo e(strtoupper($summary['sub_kegiatan'])); ?></div>

<div class="label">PEKERJAAN</div>
<div class="value"><?php echo e(strtoupper($laporans->first()->pekerjaan)); ?></div>

<div class="label">LOKASI</div>
<div class="value"><?php echo e(strtoupper($summary['lokasi'])); ?></div>

<div class="label">TAHUN ANGGARAN</div>
<div class="value"><?php echo e(date('Y',strtotime($summary['tanggal_mulai']))); ?></div>
</div>

<div class="boxwrap">
<div class="box">
<h3>KONTRAKTOR / KONTRAKTOR PELAKSANA</h3>
<div class="company"><?php echo e(strtoupper($summary['kontraktor'])); ?></div>
<div class="addr"><?php echo e($summary['alamat_kontraktor'] ?? '-'); ?></div>
</div>

<div class="box" style="float:right">
<h3>KONSULTAN PENGAWAS</h3>
<div class="company"><?php echo e(strtoupper($summary['konsultan'])); ?></div>
<div class="addr"><?php echo e($summary['alamat_konsultan'] ?? 'Jl. Terusan Kayan No. A-22 RT.006 RW.XVIII Kel. Bunulrejo Kec. Blimbing Kota Malang'); ?></div>
</div>
...
<?php /**PATH C:\Users\akuna\OneDrive\Dokumen\ARIYA MILAARA\pkn\Bot-Monitoring-Pekerjaan\Bot-Monitoring-Pekerjaan\resources\views/pdf/cover-weekly.blade.php ENDPATH**/ ?>