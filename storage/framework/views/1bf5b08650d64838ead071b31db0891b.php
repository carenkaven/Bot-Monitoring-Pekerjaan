        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
            ...
            <div>
                <div class="flex flex-wrap gap-2 mb-2">
                    <button type="button" onclick="pilihFormatLaporan('Laporan Mingguan Lama', '<?php echo e(route('pdf.weekly', ['minggu' => $summary['minggu_ke'], 'proyek' => $summary['nama_proyek']])); ?>', '<?php echo e(route('excel.weekly', ['minggu' => $summary['minggu_ke'], 'proyek' => $summary['nama_proyek']])); ?>')" class="inline-flex items-center justify-center rounded-md bg-red-600 py-2.5 px-5 font-medium text-white hover:bg-red-700 transition">Laporan Mingguan Lama</button>
                    <button type="button" onclick="pilihFormatLaporan('Laporan Mingguan Baru', '<?php echo e(route('pdf.weekly.physical', ['minggu' => $summary['minggu_ke'], 'proyek' => $summary['nama_proyek']])); ?>', '<?php echo e(route('excel.weekly.physical', ['minggu' => $summary['minggu_ke'], 'proyek' => $summary['nama_proyek']])); ?>')" class="inline-flex items-center justify-center rounded-md bg-orange-600 py-2.5 px-5 font-medium text-white hover:bg-orange-700 transition">Laporan Mingguan Baru</button>
                </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $laporans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-meta-4/50 transition">
                                ...
                                <td class="py-4 px-4 text-center">
                                    ...
                                    <a href="<?php echo e(route('excel.harian', $laporan->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bot-Monitoring-Pekerjaan\resources\views/weekly/show.blade.php ENDPATH**/ ?>