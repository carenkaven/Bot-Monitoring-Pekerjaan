    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="mt-1 text-gray-500 dark:text-gray-400">
                Selamat datang, <b class="text-black dark:text-white"><?php echo e(Auth::user()->name); ?></b>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white dark:bg-boxdark border border-stroke dark:border-strokedark rounded-3xl shadow-lg p-6">
                ...
                <p class="text-3xl font-bold text-slate-800 dark:text-white mt-2"><?php echo e($totalLaporan); ?></p>
            </div>
                    ...
                    <tbody class="divide-y divide-stroke dark:divide-strokedark">
                        <?php $__empty_1 = true; $__currentLoopData = $laporanTerakhir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-meta-4/50 transition">
                                <td class="px-6 py-4 text-black dark:text-white"><?php echo e($laporan->tanggal->format('d-m-Y')); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\akuna\OneDrive\Dokumen\ARIYA MILAARA\pkn\Bot-Monitoring-Pekerjaan\Bot-Monitoring-Pekerjaan\resources\views/karyawan/dashboard.blade.php ENDPATH**/ ?>