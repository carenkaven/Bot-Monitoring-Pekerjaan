...
<body>
                                ...
                                <tr>
                                    @foreach($fotoDokumentasi as $src)
                                        <td style="width:33.33%; border:none; padding:2px; text-align:center; vertical-align:middle;">
                                            <img src="{{ $src }}" width="72" height="54" style="object-fit:cover; display:block; margin: 0 auto;" alt="Foto dokumentasi">
                                        </td>
                                    @endforeach
                                </tr>
                            </table>
    ...
    <table class="grid">
        ...
        <tr>
            <td class="top" style="padding: 5px; height: 50px;">{!! nl2br(e($laporan->kendala ?: '-')) !!}</td>
            <td class="top" style="padding: 5px;">{!! nl2br(e($laporan->keterangan ?: '-')) !!}</td>
            <td class="top" style="padding: 5px;">{!! nl2br(e($laporan->catatan ?: '-')) !!}</td>
        </tr>
    </table>
