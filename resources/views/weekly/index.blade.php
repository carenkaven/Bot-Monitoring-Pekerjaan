...
@section('content')
    ...
    <div class="mb-6 rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900 p-5">
        <form method="GET" action="{{ route('weekly.index') }}" class="flex flex-col sm:flex-row gap-3">
    ...
    <div
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-meta-4/50 transition">
                            ...
                            <td class="py-4 px-2">
                                <div class="flex justify-center gap-2">
                                    <a href="{{ route('weekly.show', ['minggu' => $row['minggu_ke'], 'proyek' => $row['nama_proyek']]) }}"
        ...
        @if(method_exists($weeklyReports, 'links'))
            <div class="mt-4 p-4 border-t border-gray-100 dark:border-gray-800">
                {{ $weeklyReports->links('pagination::tailwind') }}
            </div>
        @endif
    </div>
